package com.example.deliveryapp.presentation.util
...
//import com.example.deliveryapp.presentation.profile.Profile
...
fun BottomBar(navController: NavHostController) {
    ...
    FoodikeBottomNavigation(
        ...
        BottomNavigationItem(
            icon =
            {
                Icon(
                    ...
                    contentDescription = stringResource(com.example.deliveryapp.R.string.home),
                )
            },
        ...
        BottomNavigationItem(
            ...
            {
                Icon(
                    painter = painterResource(com.example.deliveryapp.R.drawable.ic_baseline_assignment_24),
                    contentDescription = stringResource(com.example.deliveryapp.R.string.history),
                )
            },
